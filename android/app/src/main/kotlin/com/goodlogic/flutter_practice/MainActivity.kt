...
class MainActivity: FlutterActivity() {
    private val CHANNEL = "my.flutter/battery"
    private val BATTERYLEVEL = "getBatteryLevel"
    private val INFO = "getInfo"
                ...
                .setMethodCallHandler{
                    ...
                    if(call.method == BATTERYLEVEL){
                        ...
                        if (batteryLevel != -1){
                            ...
                            result.error("UNAVALIBLE","Battery level not available",null)
                        }
